...
function f_headermenu()
{
	...
	$EnlaceEmpresa = "http://localhost/dyccompe/empresa.php";
	$EnlaceTiendas = "http://localhost/dyccompe/tiendas.php";
	$EnlaceContacto = "http://localhost/dyccompe/contacto.php";
	$EnlaceMiCuenta = "http://localhost/dyccompe/acceso.php";
	...
	echo "
			...
			<div class='nav row rounded-top align-items-strech justify-content-between'>
				...
				<nav class='col-md-12 col-lg-auto menu d-flex align-items-stretch flex-wrap flex-sm-nowrap'>
					<a href='".$EnlaceHome."' class='c-1 d-flex align-items-center'>
						<div class='d-flex flex-column text-center'>
							<span>Home</span>
							<i class='icono icon-home-outline'></i>
						</div>
					</a>
					<a href='".$EnlaceEmpresa."' class='c-2 d-flex align-items-center'>
						<div class='d-flex flex-column text-center'>
							<span>Acerca de</span>
							<i class='icono icon-user'></i>
						</div>
					</a>
					<a href='".$EnlaceTiendas."' class='c-3 d-flex align-items-center'>
						<div class='d-flex flex-column text-center'>
							<span>Tiendas</span>
							<i class='icono icon-home'></i>
						</div>
					</a>
					<a href='".$EnlaceContacto."' class='c-4 d-flex align-items-center'>
						<div class='d-flex flex-column text-center'>
							<span>Contacto</span>
							<i class='icono icon-mail'></i>
						</div>
					</a>
					<a href='".$EnlaceMiCuenta."' class='c-5 d-flex align-items-center'>
						<div class='d-flex flex-column text-center'>
							<span>Acceso</span>
